...
namespace Bangazon
{
     public class Order
    {
        ...
        public static void addOrder(int idCust, int idPmt, List<Product> orderProds)
        {
            ...
            using (SqlConnection connection2 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\Letch\\Documents\\Visual Studio 2015\\Projects\\BangazonExercise\\Bangazon\\Bangazon\\BangazonDatabase.mdf\";Integrated Security=True"))
            ...
            {
                SqlConnection sqlConnection3 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"C:\\Users\\Letch\\Documents\\Visual Studio 2015\\Projects\\BangazonExercise\\Bangazon\\Bangazon\\BangazonDatabase.mdf\";Integrated Security=True");
